...
<head>
	<meta charset="UTF-8">
	<title>Table Education Level </title>
...
<body>
	...
	<div id="id_hide_1" class="parent">	
    	...
    	<div id="toolbar_one">
			<b style="color:black;background-color:yellow;">&nbsp edu &nbsp</b>
...
<script type="text/javascript">
	...
	$(function(){
		$('#dg_one').datagrid({
			...
			pageList: [25, 50, 100],
			idField:'',
			url: "edu_utility.php?method=GetData_one",
			columns:[[
				{field:'edu_id',title:'Edu ID',width:'20%',sortable:true,hidden:true},
				{field:'edu_code',title:'Edu Code',width:'20%',sortable:true},
    ...
    function add_one(){
        ...
        $('#fm_one').form('clear');
		url = "edu_utility.php?method=saveAddNew_one";
    }
    ...
    function edit_one(){
        ...
        if (row){
			...
			url = "edu_utility.php?method=saveEdit_one";
        }
    }
    ...
    function del_one(){
        ...
        if (row){
        	...
        	$('#fm_one').form('load',row);
			url = "edu_utility.php?method=saveDelete_one";
        }
    }
